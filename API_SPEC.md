...
No content body returned on successful deletion.
## 1. Authentication
...
| start_date | date   | Filter tanggal mulai (trx_date)|
| end_date   | date   | Filter tanggal akhir (trx_date)|
| per_page   | int    | Items per page (default: 15)   |
| page       | int    | Page number (default: 1)       |- Admin dapat mengakses semua data LPZ.
