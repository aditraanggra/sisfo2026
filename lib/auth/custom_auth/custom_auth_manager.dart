...
class CustomAuthManager {
  ...
  SisfoAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = SisfoAuthUser(
      loggedIn: true,
      uid: authUid,
      userData: userData,
    );
    sisfoAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
