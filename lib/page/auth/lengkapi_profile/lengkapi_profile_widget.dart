                ...
                child: Column(
                  ...
                  children: [
                    FutureBuilder<ApiCallResponse>(
                      future: MiscEndPointGroup.getDesaCall.call(
                        districtId: _model.kecamatanId.toString(),
                      ),
                      builder: (context, snapshot) {
                        // Customize what your widget looks like when it's loading.
                        if (!snapshot.hasData) {
                        ...
                        final formGetDesaResponse = snapshot.data!;
                              ...
                              children: [
                                ...
                                Align(
                                  ...
                                  child: Padding(
                                    ...
                                    child: FlutterFlowRadioButton(
                                      options:
                                          ['DKM', 'Desa', 'Kecamatan'].toList(),
                                      onChanged: (val) => safeSetState(() {}),
                                      controller:
                                          _model.kategoriUpzValueController ??=
                                ...
                                Padding(
                                  ...
                                  child: Container(
                                    ...
                                    child: TextFormField(
                                      ...
                                      validator: _model
                                          .namaUpzTextControllerValidator
                                          .asValidator(context),
                                      inputFormatters: [
                                        if (!isAndroid && !isiOS)
                                ...
                                Padding(
                                  ...
                                  child: FlutterFlowDropDown<int>(
                                    controller:
                                        _model.dropKecamatanValueController ??=
                                            FormFieldController<int>(null),
                                    options: List<int>.from(MiscEndPointGroup
                                        .getKecamatanCall
                                        .listIdKecamatan(
                                      lengkapiProfileGetKecamatanResponse
                                          .jsonBody,
                                    )!),
                                    optionLabels: MiscEndPointGroup
                                        .getKecamatanCall
                                        .listNameKecamatan(
                                      lengkapiProfileGetKecamatanResponse
                                          .jsonBody,
                                    ...
                                    onChanged: (val) async {
                                      ...
                                      safeSetState(() {});
                                      safeSetState(() {
                                        _model.dropDesaValueController?.reset();
                                ...
                                Padding(
                                  ...
                                  child: FlutterFlowDropDown<int>(
                                    ...
                                    options: List<int>.from(MiscEndPointGroup
                                        .getDesaCall
                                        .listDesaId(
                                      formGetDesaResponse.jsonBody,
                                    )!),
                                    optionLabels: MiscEndPointGroup.getDesaCall
                                        .listDesaName(
                                      formGetDesaResponse.jsonBody,
                                    )!,
                                    onChanged: (val) => safeSetState(
                                        () => _model.dropDesaValue = val),
                                    width: double.infinity,
                                    height: 50.0,
                                    searchHintTextStyle:
                                        FlutterFlowTheme.of(context)
                                ...
                                Padding(
                                  ...
                                  child: Container(
                                    ...
                                    child: TextFormField(
                                      controller:
                                          _model.sekretarisTextController,
                                ...
                                Padding(
                                  ...
                                  child: Container(
                                    ...
                                    child: TextFormField(
                                      controller:
                                          _model.bendaharaTextController,
                                ...
                                Padding(
                                  ...
                                  child: Container(
                                    ...
                                    child: TextFormField(
                                      controller:
                                          _model.waOperatorTextController,
                                      focusNode: _model.waOperatorFocusNode,
                                      autofocus: false,
                                      autofillHints: [AutofillHints.email],
                                      obscureText: false,
                                      decoration: InputDecoration(
                                        labelText: 'Contoh: 0812xxxxxx',
                                        labelStyle: FlutterFlowTheme.of(context)
                                            .labelMedium
                                            .override(
                                              font: GoogleFonts.notoSans(
                                      ...
                                      keyboardType: TextInputType.emailAddress,
                                      validator: _model
                                          .waOperatorTextControllerValidator
                                          .asValidator(context),
                                    ),
                                  ),
                                ),
                                Padding(
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      ...
                                      await AuthEndPointGroup.addProfileUPZCall
                                          .call(
                                        token: currentAuthenticationToken,
                                        userId: currentUserData?.id,
                                        noSk: _model.noSKTextController.text,
                                        unitName:
                                            _model.namaUpzTextController.text,
                                        noRegister:
                                            '3203000${currentUserData?.id.toString()}',
                                        address:
                                            _model.alamatTextController.text,
                                        unitLeader:
                                            _model.ketuaTextController.text,
                                        unitAssistant: _model
                                            .sekretarisTextController.text,
                                        unitFinance:
                                            _model.bendaharaTextController.text,
                                        operatorPhone: _model
                                            .waOperatorTextController.text,
                                        profileCompletion: 100,
                                        categoryId: () {
                                          if (_model.kategoriUpzValue ==
                                              'DKM') {
                                            return 4;
                                          } else if (_model.kategoriUpzValue ==
                                              'Desa') {
                                            return 3;
                                          } else {
                                            return 2;
                                      ...
                                      FFAppState().profileUPZ =
                                          UpzStruct.fromSerializableMap(
                                              jsonDecode('{}'));
                                      safeSetState(() {});
