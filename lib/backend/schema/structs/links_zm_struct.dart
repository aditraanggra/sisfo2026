...
class LinksZmStruct extends BaseStruct {
  LinksZmStruct({
    String? first,
    String? last,
    String? prev,
  ...
  static LinksZmStruct fromMap(Map<String, dynamic> data) => LinksZmStruct(
  ...
  static LinksZmStruct? maybeFromMap(dynamic data) =>
      data is Map ? LinksZmStruct.fromMap(data.cast<String, dynamic>()) : null;
  ...
  static LinksZmStruct fromSerializableMap(Map<String, dynamic> data) =>
      LinksZmStruct(
  ...
  @override
  String toString() => 'LinksZmStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    return other is LinksZmStruct &&
        first == other.first &&
        last == other.last &&
        prev == other.prev &&
        next == other.next;
...
LinksZmStruct createLinksZmStruct({
  String? first,
  String? last,
  String? prev,
  String? next,
