...
class SelectedSMPStruct extends BaseStruct {
  SelectedSMPStruct({
    int? id,
    String? nama,
    String? kecamatan,
  ...
  static SelectedSMPStruct fromMap(Map<String, dynamic> data) =>
      SelectedSMPStruct(
  ...
  static SelectedSMPStruct? maybeFromMap(dynamic data) => data is Map
      ? SelectedSMPStruct.fromMap(data.cast<String, dynamic>())
      : null;
  ...
  static SelectedSMPStruct fromSerializableMap(Map<String, dynamic> data) =>
      SelectedSMPStruct(
        id: deserializeParam(
          data['id'],
          ParamType.int,
  ...
  @override
  String toString() => 'SelectedSMPStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    return other is SelectedSMPStruct &&
        id == other.id &&
        nama == other.nama &&
  ...
  int get hashCode => const ListEquality()
      .hash([id, nama, kecamatan, npsn, status, kecamatanId]);
}

SelectedSMPStruct createSelectedSMPStruct({
  int? id,
  String? nama,
  String? kecamatan,
  String? npsn,
