...
class SelectedSDStruct extends BaseStruct {
  SelectedSDStruct({
    int? id,
    String? nama,
    String? kecamatan,
  ...
  static SelectedSDStruct fromMap(Map<String, dynamic> data) =>
      SelectedSDStruct(
  ...
  static SelectedSDStruct? maybeFromMap(dynamic data) => data is Map
      ? SelectedSDStruct.fromMap(data.cast<String, dynamic>())
      : null;
  ...
  static SelectedSDStruct fromSerializableMap(Map<String, dynamic> data) =>
      SelectedSDStruct(
        id: deserializeParam(
          data['id'],
          ParamType.int,
  ...
  @override
  String toString() => 'SelectedSDStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    return other is SelectedSDStruct &&
        id == other.id &&
        nama == other.nama &&
...
SelectedSDStruct createSelectedSDStruct({
  int? id,
  String? nama,
  String? kecamatan,
  String? npsn,
