...
class LinksIfsStruct extends BaseStruct {
  LinksIfsStruct({
    String? first,
    String? last,
    String? prev,
  ...
  static LinksIfsStruct fromMap(Map<String, dynamic> data) => LinksIfsStruct(
  ...
  static LinksIfsStruct? maybeFromMap(dynamic data) =>
      data is Map ? LinksIfsStruct.fromMap(data.cast<String, dynamic>()) : null;
  ...
  static LinksIfsStruct fromSerializableMap(Map<String, dynamic> data) =>
      LinksIfsStruct(
  ...
  @override
  String toString() => 'LinksIfsStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    return other is LinksIfsStruct &&
        first == other.first &&
        last == other.last &&
        prev == other.prev &&
        next == other.next;
...
LinksIfsStruct createLinksIfsStruct({
  String? first,
  String? last,
  String? prev,
  String? next,
