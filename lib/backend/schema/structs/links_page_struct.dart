...
class LinksPageStruct extends BaseStruct {
  LinksPageStruct({
    String? first,
    String? last,
    String? prev,
  ...
  static LinksPageStruct fromMap(Map<String, dynamic> data) => LinksPageStruct(
  ...
  static LinksPageStruct? maybeFromMap(dynamic data) => data is Map
      ? LinksPageStruct.fromMap(data.cast<String, dynamic>())
      : null;
  ...
  static LinksPageStruct fromSerializableMap(Map<String, dynamic> data) =>
      LinksPageStruct(
  ...
  @override
  String toString() => 'LinksPageStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    return other is LinksPageStruct &&
        first == other.first &&
        last == other.last &&
        prev == other.prev &&
        next == other.next;
...
LinksPageStruct createLinksPageStruct({
  String? first,
  String? last,
  String? prev,
  String? next,
