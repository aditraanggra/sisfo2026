...
import 'card_setor_zis_model.dart';
export 'card_setor_zis_model.dart';

class CardSetorZisWidget extends StatefulWidget {
  const CardSetorZisWidget({
    super.key,
    String? namaZis,
    int? nominalSetor,
    ...
    required this.setCurrentSetor,
        ...
        this.nominalSetor = nominalSetor ?? 0;

  final String namaZis;
  final int nominalSetor;
  final Future Function()? updateStateSetor;
  final Future Function()? resetSetor;
  final Future Function()? setCurrentSetor;

  @override
  State<CardSetorZisWidget> createState() => _CardSetorZisWidgetState();
}

class _CardSetorZisWidgetState extends State<CardSetorZisWidget> {
  late CardSetorZisModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CardSetorZisModel());
